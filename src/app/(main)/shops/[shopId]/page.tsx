...
export default function ShopDetailPage() {
    ...
    const [shopIdForNotices, setShopIdForNotices] = useState<string | null>(
        null
    );
        ...
        const loadShopData = async () => {
            try {
                ...
                if (id && id !== "undefined") {
                    ...
                    console.log(
                        "[ShopDetailPage] URL ID로 가게 조회 결과:",
                        !!shopData
                    );
                }
                ...
                if (userId) {
                    console.log(
                        "[ShopDetailPage] 사용자 ID로 가게 조회 시도:",
                        userId
                    );
                ...
                console.log(
                    "[ShopDetailPage] 가게를 찾지 못함, 등록 카드 표시"
                );
                localStorage.removeItem(SHOP_ID_STORAGE_KEY);
                setShouldShowRegisterCard(true);
            } catch (error) {
        ...
        <div className="max-w-[964px] mx-auto px-6 py-10">
            ...
            <section className="relative -mx-6 -mb-10">
                ...
                <div className="px-6 py-10">
                    {shopIdForNotices && (
                        <ShopNotices shopId={shopIdForNotices} />
                    )}
                </div>
            </section>
        </div>
